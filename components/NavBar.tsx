...
import { Leaf, Menu, X, LayoutDashboard, Home, Sun, Moon, LogIn, LogOut, CalendarIcon, UserCircle } from "lucide-react";
        ...
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8">
            ...
            <Link 
              ...
              className={clsx(
                "text-sm font-medium transition-colors hover:text-emerald-600 dark:hover:text-emerald-400",
                isActive("/calendar") ? "text-emerald-600 dark:text-emerald-400" : "text-slate-500 dark:text-slate-400"
              )}
            >
              Calendar
            </Link>
            <Link
              ...
              className={clsx(
                "text-sm font-medium transition-colors hover:text-emerald-600 dark:hover:text-emerald-400",
                isActive("/profile") ? "text-emerald-600 dark:text-emerald-400" : "text-slate-500 dark:text-slate-400"
              )}
            >
              Profile
            </Link>
              ...
              <div className="pt-2 border-t border-slate-100 dark:border-slate-800">
                {session ? (
                  <button
                    ...
                    className="flex items-center justify-center gap-2 w-full bg-emerald-600 hover:bg-emerald-700 text-white py-2 rounded-lg font-medium transition-colors"
                  >
                    <LogOut className="w-4 h-4" />
                    Sign Out
                  </button>
